...
The data required to knit this rmd file are included in the repository, except that a) the data at `METHYLATION_PATH` may be requested from
...
be archived by or available from the authors of:
